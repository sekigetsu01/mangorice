        ...
        ListView {
            ...
            MouseArea {
                ...
                onWheel: function(wheel) {
                    if (wheel.angleDelta.y > 0) { if (root.selectedIndex > 0)                  { root.focusSource = "mouse"; root.selectedIndex--; listView.positionViewAtIndex(root.selectedIndex, ListView.Contain); } }
                    else                         { if (root.selectedIndex < emojiModel.count-1) { root.focusSource = "mouse"; root.selectedIndex++; listView.positionViewAtIndex(root.selectedIndex, ListView.Contain); } }
                    wheel.accepted = true;
                }
            }
                    ...
                    Item {
                        ...
                        Text {
                            ...
                            color: emojiRow.saved ? theme.clrStar
                                 ...
                                 : (emojiRow.mouseOver || emojiRow.isSel) ? theme.clrStarOff
                                 : "transparent"

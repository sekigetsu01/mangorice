...
// Delete cookies and site data on shutdown, but respect per-site exceptions.
// To whitelist a site: Settings > Privacy & Security > Cookies > Manage Exceptions.
...
// Disable fingerprint resistance (can break some sites and Google Maps, etc.):
